<template>
  <div class="swiper_wrap">
		<ul class="font_inner">
			<li v-for="(item, index) in advTitle" @click="jump(item,index)">
				{{item[0]}}
			</li>
		</ul>
...
export default {
  ...
  data () {
    return {
      ...
      //   },{
      //     title: "222222222222222222222222222",
      //     route: "http://www.alibaba.com"
      //   },{
      //     title: "333333333333333333333333333",
      //     route: "http://www.tianmao.com"
      //   }
      // ]
      advTitle: [
        [""],
  ...
  methods: {
    getText: function() {
      this.$ajax.get('dashboard/viewInterfaceJ').then((res) => {
